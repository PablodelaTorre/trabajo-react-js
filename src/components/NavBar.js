    ...
    <>
        ...
        <nav className='d-flex 100vw justify-content-between align-items-center bgNav'>
            ...
            <ul className='d-flex mx-4 align-items-center list-unstyled paddingNone marginNone'>
                <li className='mx-3 linkNav'><Link className='text-decoration-none linkNav' to="home">Home</Link></li>
                <li className='mx-3 linkNav'><Link className='text-decoration-none linkNav' to="productos">Productos</Link></li>
                <li className='mx-3 linkNav'><Link className='text-decoration-none linkNav' to="contacto">Contacto</Link></li>
